<div id="demo-set" class="demo-set">
    <div class="demo-set-body bg-dark">
            ...
            <div class="col-xs-12 col-lg-12"> 
                <div id="demo-theme">
                    <div class="demo-theme-btn">
                        <h4 class="mar-btm text-thin">Themes</h4>
        ...
        <div class="pad-all text-left bg-purple">
            <p class="demo-set-save-text">* All settings will be saved automatically.</p>
            <hr class="hr-sm">
            <button id="demo-reset-settings" class="btn btn-dark">Restore Default Settings</button>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><span id="lec_title"></span>  
                    <span style="z-index:5;" class="pull-right"><a id="download" href="#">Download</a> &nbsp;&nbsp;</span></h4>
            </div>
            <div class="modal-body">
                <div id="pdf" style="max-height:550px !important;">
                    It appears you don't have Adobe Reader or PDF support in this web browser.
                    <a id="fixlink" href="#">Click here to download the PDF</a>
                </div>
            </div>
            <?php
            //echo $lec_id;
...
<!--video modal-->
<div class="modal fade bs-example-modal-lg" id="myModal-video" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title" id="myModalLabel"><span id="video_title">&nbsp;</span>
                    <span style="z-index:5;" class="pull-right"><a id="download" href="#"></a> &nbsp;&nbsp;</span></h4>
            </div>
            <div class="modal-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe id="vid" width="560" height="315" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
