...
Switchery.prototype.create = function() {
  ...
  if(this.options.size){
    this.switcher.className += " ";
    this.switcher.className += this.options.size;    
  }else if(this.element.getAttribute('data-size')){
    this.switcher.className += " ";
    this.switcher.className += this.element.getAttribute('data-size');   
  }
